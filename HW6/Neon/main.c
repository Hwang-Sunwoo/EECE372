...
void func() {
    ...
    int16x8_t arr1_0=vld1_s16(arr1);	// 1st row of arr1
    int16x8_t arr1_1=vld1_s16(arr1+8);	// 2nd row of arr1
    int16x8_t arr1_2=vld1_s16(arr1+16);	// 3rd row of arr1
    int16x8_t arr1_3=vld1_s16(arr1+24);	// 4th row of arr1
    int16x8_t arr1_4=vld1_s16(arr1+32);	// 5th row of arr1
    int16x8_t arr1_5=vld1_s16(arr1+40);	// 6th row of arr1
    int16x8_t arr1_6=vld1_s16(arr1+48);	// 7th row of arr1
    int16x8_t arr1_7=vld1_s16(arr1+56);	// 8th row of arr1
